    ...
    <body>
        ...
        <div class="contenitore-g">
            ...
            <div class="container-film">
                <div class="titolo"><h1>La La Land (2016)</h1></div>
                <div class="rating">
                ...
                <div class="riassunto"><h1>Riassunto</h1>
                    <p>La La Land è un film del 2016 diretto da Damien Chazelle.
                ...
                <div class="caratteristiche">
                    <h2>Genere:</h2><p>Romantico Musical</p>
                    <h2>Durata:</h2><p>128 min </p>
                    <h2>Regista:</h2><p>Damien Chazelle </p>
                    <h2>Settings:</h2><p>USA </p>
                    <h2>Attori:</h2><p>Ryan Gosling<br>Emma Stone<br> 
                        John Legend<br>
                        J. K. Simmons<br>
                        Rosemarie DeWitt<br> 
                    </p>
                    <h2>Casa produttrice:</h2><p>Summit Entertainment, Black Label Media, Gilbert Films, Impostor Pictures, Marc Platt Productions </p>
                    <h2>Lingua originale:</h2><p>Inglese </p>
                </div>
                <div class="image"><img src="../../immagini/Film/Film Romantici/la la land.jpg"></div>
                <a target="_blank" href="https://www.youtube.com/watch?v=YbtJyxjXpMI" rel="noopener" id="trail">
                    <div class="trailer">
                    Trailer
                    </div>
                </a>
